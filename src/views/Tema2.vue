  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .crd.crd--grayBlue.crd--brad.p-4(data-aos="fade-in")
      LineaTiempoC.color-acento-contenido(text-small)
        .row(titulo="1")        
          figure
            img(src='@/assets/curso/temas/tema2/t2_08.svg', alt='')
        .row(titulo="2")        
          figure
            img(src='@/assets/curso/temas/tema2/t2_09.svg', alt='')
        .row(titulo="3")        
          figure
            img(src='@/assets/curso/temas/tema2/t2_10.svg', alt='')
        .row(titulo="4")        
          figure
            img(src='@/assets/curso/temas/tema2/t2_11.svg', alt='')
        ...
        .col-lg-10(data-aos="fade-in")
          SlyderF(columnas="col-lg-6 col-xl-4")
            ...
            .crd.crd--mint.crd--brad.fullHg
              ...
              h5.text-center.p-3 Promueve las ventas y la rotación del inventario.
            .crd.crd--mint.crd--brad.fullHg
              figure
                img(src="@/assets/curso/temas/tema2/t2_14.png", alt="alt")                
              h5.text-center.p-3 Genera posicionamiento de marca y visibilidad. 
            .crd.crd--mint.crd--brad.fullHg
              figure
                img(src="@/assets/curso/temas/tema2/t2_15.png", alt="alt")                
              h5.text-center.p-3 Permite la presentación de nuevos productos y servicios.
            .crd.crd--mint.crd--brad.fullHg
              figure
                img(src="@/assets/curso/temas/tema2/t2_16.png", alt="alt")                
              h5.text-center.p-3 Facilita la comunicación con el consumidor.

      p.mb-5(data-aos="fade-in") Además del concepto, es muy importante tener claridad sobre la diferencia entre promoción y publicidad. 

      .row.justify-content-center
        .col-lg-10.mb-4(data-aos="fade-in")
          .titulo-sexto.color-acento-contenido.mb-5
            h5 Tabla 2.
            span Promoción y publicidad 
          .tabla-a.cstm_clr_01
            table
              thead
                tr
              ...
              tbody
                tr
                  td Es el plan de trabajo que utilizando los medios de comunicaci&oacute;n permite el anuncio de los productos o servicios de una empresa o marca.<br><br>Por ejemplo, muestras gratuitas, concursos, campa&ntilde;as en redes sociales, etc.
                  td Son el conjunto de mensajes que llegan al consumidor a trav&eacute;s de los medios de comunicaci&oacute;n.<br><br>El contenido que se dise&ntilde;a tiene la particularidad de ser controlado y el espacio para su difusi&oacute;n es pago.<br><br>Por ejemplo, los anuncios en la red social Facebook.

        .col-lg-10(data-aos="zoom-in")
          .crd.crd--mint.p-4
            .row.justify-content-center.align-items-center
              .col-lg
                p.mb-0 En conclusión, la promoción y la publicidad tienen un mismo propósito, atraer clientes y alcanzar un mejor posicionamiento y visibilidad en el mercado utilizando diferentes canales de comunicación y distinto contenido.
              .col-auto
                figure
                  img(src="@/assets/curso/temas/tema2/t2_17.svg", alt="alt").img110
